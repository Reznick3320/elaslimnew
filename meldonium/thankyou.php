...
<body>
  ...
  <main>
    <div class='thankyou <?php if (!$upsellsEnabled || $error) echo 'thankyou--full' ?>'>
      ...
      <?php if (!$error) : ?>
        <h1 class="thankyou__title"><?php if (!empty($name)) echo "<b>$name</b>" ?>!Спасибо за заказ!</h1>
        <p>
          Оператор свяжется с Вами в близжайшее время <?php if (!empty($phone)) echo "по номеру <b>$phone</b>" ?>
        </p>
          ...
          <div class="upsell">
            ...
            <div class="upsell__text">
              <div>
                ...
                <img class="upsell__rating" src="./assets/thankyou-rating.png" alt="img">
